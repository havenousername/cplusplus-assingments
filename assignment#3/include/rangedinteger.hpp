#ifndef RANGEDINTEGER_HPP
#define RANGEDINTEGER_HPP
...
public:
    ...
    template <typename otherT, int otherTmin, int otherTmax>
    friend std::ostream & operator<<(std::ostream &os, BoundedValue<otherT, otherTmin, otherTmax> &other);
...
template <typename otherT, int otherTmin, int otherTmax>
std::ostream & operator<<(std::ostream &os, BoundedValue<otherT, otherTmin, otherTmax> &other)
{
        return os << other.getVal();
}
